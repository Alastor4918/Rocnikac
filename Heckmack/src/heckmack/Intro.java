...
public class Intro implements Screen {
	...
	public Intro(final GameStart gam) {
		...
		logo= new Texture(Gdx.files.internal("heckmeck2.png"));
		cucak=new Texture(Gdx.files.internal("wat/cucak.png"));
		skrtic=new Texture(Gdx.files.internal("wat/skrtic.png"));
		
		Texture temp= new Texture(Gdx.files.internal("wat/background.png"));
